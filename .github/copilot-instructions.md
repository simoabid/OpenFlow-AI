# OpenFlow-AI (OpenFlow) - AI Phone Operator Android App

OpenFlow-AI is an Android application written in Kotlin that serves as a proactive, on-device AI agent for Android. It uses accessibility services to understand and operate phone UI, supporting voice commands and AI-powered task automation.
...
2. **Clone and configure API keys:**
   ```bash
   git clone https://github.com/simoabid/OpenFlow-AI.git
   cd OpenFlow-AI
...
./gradlew test --tests="com.seemoo.openflow.agent.v2.SystemPromptTest"
```
...
# Install and launch
./gradlew installDebug && adb shell am start -n com.seemoo.openflow/.MainActivity
...
2. **Grant accessibility permission**: Enable "OpenFlow-AI" in Settings > Accessibility
...
### Key Directories
```
app/src/main/java/com.seemoo.openflow/
...
### Important Files
- `app/src/main/java/com.seemoo.openflow/services/AgentTaskService.kt` - Core agent execution service
- `app/src/main/java/com.seemoo.openflow/api/GeminiApi.kt` - Gemini AI integration
- `app/src/main/java/com.seemoo.openflow/v2/llm/GeminiAPI.kt` - Enhanced Gemini API v2
...
- **Picovoice**: Wake word detection ("Hey OpenFlow-AI")  
...
### File Locations
- Main source: `app/src/main/java/com.seemoo.openflow/`
- Tests: `app/src/test/java/com.seemoo.openflow/`
