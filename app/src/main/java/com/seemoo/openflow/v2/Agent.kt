...
import com.seemoo.openflow.v2.llm.GeminiMessage
...
import com.seemoo.openflow.overlay.OverlayPosition
import com.seemoo.openflow.SettingsActivity
...
class Agent(
    ...
    suspend fun run(initialTask: String, maxSteps: Int = 150) {
        ...
        while (!state.stopped && state.nSteps <= maxSteps) {
            ...
            val sharedPrefs = context.getSharedPreferences("OpenFlowSettings", Context.MODE_PRIVATE)
