...
class SystemPromptLoader(private val context: Context) {
    ...
    fun getSystemMessage(settings: AgentSettings): GeminiMessage {
        ...
        val userProfileManager = com.seemoo.openflow.utilities.UserProfileManager(context)
