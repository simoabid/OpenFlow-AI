package com.seemoo.openflow.v2
...
import com.seemoo.openflow.utilities.ApiKeyManager
...
import com.seemoo.openflow.v2.actions.ActionExecutor
import com.seemoo.openflow.v2.fs.FileSystem
import com.seemoo.openflow.v2.llm.GeminiApi
import com.seemoo.openflow.v2.message_manager.MemoryManager
...
class AgentService : Service() {
    ...
    companion object {
        ...
        private const val EXTRA_TASK = "com.seemoo.openflow.v2.EXTRA_TASK"
        private const val ACTION_STOP_SERVICE = "com.seemoo.openflow.v2.ACTION_STOP_SERVICE"
...
//        overlayManager.stopObserving()
    ...
    private fun createNotification(contentText: String): Notification {
        ...
        return NotificationCompat.Builder(this, NOTIFICATION_CHANNEL_ID)
            .setContentTitle("OpenFlow-AI Doing Task (Expand to stop OpenFlow-AI)")
