...
import com.seemoo.openflow.MainActivity
import com.seemoo.openflow.R
import com.seemoo.openflow.api.PorcupineWakeWordDetector
...
class EnhancedWakeWordService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        val notification: Notification = NotificationCompat.Builder(this, CHANNEL_ID)
            .setContentTitle("OpenFlow Wake Word")
            .setContentText("Listening for 'OpenFlow-AI' with Porcupine engine...")
    ...
    private fun startWakeWordDetection() {
        val onWakeWordDetected: () -> Unit = {
            ...
            if (!ConversationalAgentService.isRunning) {
                ...
                Toast.makeText(this, "OpenFlow-AI listening...", Toast.LENGTH_SHORT).show()
            } else {
