package com.seemoo.openflow.services
...
class FloatingOpenFlowButtonService : Service() {

    private var windowManager: WindowManager? = null
    private var floatingButton: View? = null

    companion object {
        private const val TAG = "FloatingOpenFlow-AIButton"
        var isRunning = false
    }
    ...
    override fun onCreate() {
        super.onCreate()
        isRunning = true
        Log.d(TAG, "Floating OpenFlow-AI Button Service created")
    }

    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        Log.d(TAG, "Floating OpenFlow-AI Button Service starting...")
    ...
    private fun showFloatingButton() {
        ...
        try {
            ...
            Log.d(TAG, "Floating OpenFlow-AI button added successfully")
        } catch (e: Exception) {
    ...
    override fun onDestroy() {
        super.onDestroy()
        Log.d(TAG, "Floating OpenFlow-AI Button Service destroying...")
        hideFloatingButton()
        isRunning = false
    }
