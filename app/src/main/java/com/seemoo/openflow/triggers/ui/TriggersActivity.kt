package com.seemoo.openflow.triggers.ui
...
import com.seemoo.openflow.BaseNavigationActivity
import androidx.recyclerview.widget.LinearLayoutManager
import androidx.recyclerview.widget.RecyclerView
import com.seemoo.openflow.R
import com.seemoo.openflow.triggers.TriggerManager
import com.seemoo.openflow.triggers.TriggerMonitoringService
import com.seemoo.openflow.triggers.TriggerType
...
class TriggersActivity : BaseNavigationActivity() {
    ...
    private fun showBatteryOptimizationWarning(onAcknowledge: () -> Unit) {
        val dialog = AlertDialog.Builder(this)
            ...
            .setMessage("Your vendor might not support OpenFlow-AI background trigger monitoring. To ensure OpenFlow-AI works properly, please disable any kind of battery optimization for the app.")
    ...
    private fun checkNotificationPermission() {
        ...
        if (hasNotificationTriggers && !com.seemoo.openflow.triggers.PermissionUtils.isNotificationListenerEnabled(this)) {
    ...
    private fun showPermissionDialog() {
        val dialog = AlertDialog.Builder(this)
            ...
            .setMessage("To use notification-based triggers, you need to grant OpenFlow-AI the Notification Listener permission in your system settings.")
    ...
    private fun showDeleteConfirmationDialog(trigger: com.seemoo.openflow.triggers.Trigger) {
        val dialog = AlertDialog.Builder(this)
