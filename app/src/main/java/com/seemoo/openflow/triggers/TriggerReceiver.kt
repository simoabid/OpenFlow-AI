...
class TriggerReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val ACTION_EXECUTE_TASK = "com.seemoo.openflow.action.EXECUTE_TASK"
        const val EXTRA_TASK_INSTRUCTION = "com.seemoo.openflow.EXTRA_TASK_INSTRUCTION"
        const val EXTRA_TRIGGER_ID = "com.seemoo.openflow.EXTRA_TRIGGER_ID"
