package com.seemoo.openflow.triggers
...
class OpenFlowNotificationListenerService : NotificationListenerService() {

    private val TAG = "OpenFlow-AINotification"
    ...
    override fun onNotificationPosted(sbn: StatusBarNotification?) {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            if (matchingTrigger != null) {
                ...
                val intent = android.content.Intent(this@OpenFlowNotificationListenerService, TriggerReceiver::class.java).apply {
