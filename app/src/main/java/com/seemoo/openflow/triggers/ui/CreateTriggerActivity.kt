...
import com.seemoo.openflow.triggers.PermissionUtils
import com.seemoo.openflow.triggers.Trigger
...
//        }
    ...
    private fun saveTrigger() {
        ...
        when (selectedTriggerType) {
            TriggerType.SCHEDULED_TIME -> {
                if (!com.seemoo.openflow.triggers.PermissionUtils.canScheduleExactAlarms(this)) {
    ...
    private fun showExactAlarmPermissionDialog() {
        val dialog = androidx.appcompat.app.AlertDialog.Builder(this)
            ...
            .setMessage("To schedule tasks at a precise time, OpenFlow-AI needs the 'Alarms & Reminders' permission. Please grant this in the next screen.")
