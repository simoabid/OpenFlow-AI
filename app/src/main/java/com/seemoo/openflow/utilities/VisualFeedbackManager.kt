...
import com.seemoo.openflow.AudioWaveView
import com.seemoo.openflow.R
import com.seemoo.openflow.ui.SmallDeltaGlowView
...
import com.seemoo.openflow.utilities.TtsVisualizer
...
class VisualFeedbackManager private constructor(private val context: Context) {
    ...
    private val openflowStateManager by lazy { OpenFlowStateManager.getInstance(context) }
    private val stateChangeListener: (OpenFlowState) -> Unit
    ...
    fun showSmallDeltaGlow() {
        mainHandler.post {
            ...
            try {
                ...
                updateSmallDeltaVisuals(openflowStateManager.getCurrentState())
     ...
     */
    private fun updateSmallDeltaVisuals(state: OpenFlowState) {
