...
## Overview
This implementation adds voice command functionality to the OpenFlow app, allowing users to speak their instructions and have them automatically executed. The feature follows a press-and-hold pattern similar to popular voice assistants, with automatic task execution and TTS feedback.
