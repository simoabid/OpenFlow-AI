...
⚠️ **OpenFlow-AI memory is turned off as of yet.**

The memory functionality in OpenFlow-AI has been temporarily disabled while we work on improvements and optimizations. This means:

## What's Affected

- **Conversational Memory**: OpenFlow-AI will not remember information from previous conversations
- **Personal Information Storage**: No personal details will be stored or recalled
- **Learning from Interactions**: OpenFlow-AI won't learn from your preferences or habits
...
- **Screen Understanding**: OpenFlow-AI can still see and interact with your screen
...
- Remember that OpenFlow-AI won't recall previous interactions
